	...
	<div id="page">
		...
		<div id="bodynobg">
			<div id="body-right">
				...
				<cfoutput>#renderItem('title','title')#</cfoutput>
				<div class="group">
					<div class="inner">
						<div class="bottom">
							<div class="inner">
								<div class="panel">
								<div id="msg"><cfoutput><cfif requestObj.isformurlvarset('msg')>#requestObj.getformurlvar('msg')#<cfelse>&nbsp;</cfif></cfoutput></div>
									<cfoutput>#renderItem('maincontent','accordion')#</cfoutput>
								</div>
							</div>
						</div>
					</div>
