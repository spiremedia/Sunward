...
<head><!-- pop up two col -->
	...
	<base href="<cfoutput>#getEsmUrl()#</cfoutput>" />
	...
	<script type="text/javascript" src="/ui/js/scriptaculous1_6_1/Pre.js"></script>	
	...
	<script type="text/javascript">
		var ExternalValues = 
		{
			...
			Ajax_InPlaceTextEditorUrl:
				'<cfoutput>#getEsmUrl()#</cfoutput>forms/inplaceeditorcallback/',
			ValueHere:
				'&lt;Value Here&gt;',
			LableHere:
				'&lt;Label Here&gt;'
