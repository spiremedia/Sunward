	...
	<cfif lcl.list.recordcount>
		<cfsavecontent variable="lcl.s.html">
			...
			<cfoutput query="lcl.list">
				<li><a <cfif lcl.id EQ id>class="selected"</cfif> href="/permissionLevel/editPermissionLevel/?id=#id#">#name#</a></li>
			</cfoutput>
			</ul>
			</div>
		</cfsavecontent>
		<cfset lcl.acc.add('Permission Levels',lcl.s.html)>
	<cfelse>
		<cfset lcl.acc.add("No Permission Levels Loaded","")>
	</cfif>
</cfsilent>
