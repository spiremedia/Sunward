<cfcomponent name="model" output="false" extends="resources.abstractContentObjectEditorModel">
	...
	<cffunction name="init">
		...
		<cfparam name="variables.recipient_general" default="">
	...
	<cffunction name="getinfo">
		...
		<cfset r.recipient_general = variables.recipient_general>
	...
	<cffunction name="setvalues">
		...
		<cfset variables.recipient_general = arguments.itemdata.recipient_general>
	...
	<cffunction name="validate">		
		...
		<cfset vdtr.validemail('recipient_general', variables.recipient_general, 'The Email Recipient for General Inquiries must be a valid email.')>
	...
	<cffunction name="save">
		...
		<cfset mydata.recipient_general = variables.recipient_general>
