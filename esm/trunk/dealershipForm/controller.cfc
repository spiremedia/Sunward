<cfcomponent name="dealershipForm" extends="resources.abstractController">
	...
	<cffunction name="editClientModule">
		...
		<cfset widgetsmodel = createObject('component','dealershipForm.widgetModel').init(arguments.requestObject, arguments.userObj)>
	...
	<cffunction name="saveClientModule">
		...
		<cfset var model = createObject('component', 'dealershipForm.widgetmodel').init(requestObject, userobj)>
