<cfsilent>
	...
	<cfoutput query="lcl.list" group="year">
		...
		<cfsavecontent variable="lcl.s.html">
			...
			<cfif lcl.list.recordcount>
				<cfoutput>
					...
					<li><a <cfif lcl.id EQ lcl.list.year & '_' & lcl.list.month>class="selected"</cfif> href="../viewByMonth/?month=#lcl.list.month#&year=#lcl.list.year#">#monthasstring(lcl.list.month)#</a></li>
				</cfoutput>
			<cfelse>
		...
		<cfset lcl.acc.add(lcl.list.year,lcl.s.html)>
	</cfoutput>
