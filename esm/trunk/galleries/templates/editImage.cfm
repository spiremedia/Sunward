...
<cfelse>
	...
	<div id="image-editor">
		<div class="toolbar">
			<button type="button" onclick="ImageEditor.revertToOriginal();" value="">Revert to Orig</button>
			...
			<!---<span class="spacer"> || </span>--->
			<button type="button" onclick="ImageEditor.rotate(270)">Rotate 90&deg;CCW</button>
			<button type="button" onclick="ImageEditor.rotate(90)">Rotate 90&deg;CW</button>
			<!---<span class="spacer"> || </span>--->
			<button type="button" onclick="ImageEditor.crop()">Crop</button>
            <br/>
