<cfcomponent name="cloudView">
	...
	<cffunction name="showHTML">
        ...
        <cfsavecontent variable="lcl.html">
			<cfoutput>
            <div class="galleries">
				<script type="text/javascript" src="/ui/js/galleries/galleria.js"></script>
				<link rel="stylesheet" href="/ui/css/galleries/galleria.css" type="text/css" />
