		...
		<cfsavecontent variable="contents">
			...
			<cfset incValue = incrementValue(incValue)>
				...
				<li <cfif arraylen(tclass)>class="#arraytolist(tclass," ")#"</cfif>>
                    ...
                    <a href="#secondurlpath#" onmouseover="document.Image#incValue#.src='/ui/img/btn_#trim(navImageName)#_over.gif'"
onmouseout="document.Image#incValue#.src='/ui/img/btn_#trim(navImageName)#.gif'">
                        <img src="/ui/img/btn_#trim(navImageName)#.gif" name="Image#incValue#" />
                    </a>
