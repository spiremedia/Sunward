            ...
            <div class="txtBottomBar1">
                ...
                <div class="splitleft">
                    ...
                    <cfif contentObjectNotEmpty('bodyCopy1')>
                       <div>
                            #showContentObject('bodyCopy1', 'htmlContent,contactForm,dealershipForm,Forms,Search', 'editable')#
                       </div>
                    </cfif>
                    <cfif contentObjectNotEmpty('bodyCopy2')>
                       <div>
                            #showContentObject('bodyCopy2', 'htmlContent,contactForm,dealershipForm,Forms,Search', 'editable')#
                       </div>
                    </cfif>
