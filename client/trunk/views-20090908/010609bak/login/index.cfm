			...
			<div id="content">
				...
				<div id="columns">
					...
					<div class="columnright">
						...
						<h2>Login</h2>
						<cfif structkeyexists(variables.pageinfo,'isError') and variables.pageinfo.isError eq true>
							<b style="font-color: ##ff0000;">Please enter a valid username and password.<br /><br /></b>
						</cfif>
						<div>
<form name="loginform" id="loginform" action="/#url.path#" method="post">
<input type="hidden" id="clientLogin" name="clientLogin" value="1" />
<table border="0" cellspacing="0" cellpadding="0">
<tr><td>Username: </td><td><input type="text" name="username" id="username"></td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td>Password: </td><td><input type="password" name="password" id="password"></td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td></td><td><input type="submit" name="login" id="login" value="Submit" /></td></tr>
</table>
</form></div>
					</div>
					<!-- end columnright -->
