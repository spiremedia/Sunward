	...
	<cffunction name="sendFormSubmissionEmailCustom">
		...
		<cfscript> 
			...
			if ( arguments.recipient neq '' )
			{
				...
				for(i = 1; i lte ArrayLen(formsubmission.formfield); i = i + 1)
				{
					body = body & '<div style=" float: left; width: 200px; ">' & formsubmission.formfield[i] & '</div>';
					body = body & '<div style=" float: left; width: 200px; font-weight: normal; ">' & formsubmission.answer[i] & '</div><br style=" clear: both;" /><br />';
