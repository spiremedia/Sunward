			...
			<xsl:for-each select="li">
				<xsl:element name="p">
					<xsl:element name="label">
						...
						<xsl:attribute name="class">
							<xsl:value-of select="'usrFrmLabel'" />
						</xsl:attribute>
						<xsl:if test="p/input[@type='checkbox' and @name='required']/@checked != ''">
							<xsl:attribute name="class">usrFrmLabel required</xsl:attribute>
						</xsl:if>
					...
					<!-- 
					///
					/// Required Form Field for Processing script
					///
					-->
					<xsl:if test="p/input[@type='checkbox' and @name='required']/@checked != ''">
						<xsl:call-template name="input">
							...
							<xsl:with-param name="size" select="''" />
							<xsl:with-param name="maxlength" select="''" />
							<xsl:with-param name="name" select="concat($fieldNameBase, 'required_', position())" />
							<xsl:with-param name="id" select="''" />
    ...
    <xsl:template name="input">
        ...
        <xsl:element name="input">
			...
			<xsl:choose>
				...
				<xsl:otherwise>
	                <xsl:attribute name="class">
	                    <xsl:value-of select="'usrFrmInputText'" />
	                </xsl:attribute>
				</xsl:otherwise>
			</xsl:choose>
        </xsl:element>
    ...
    <xsl:template name="textArea">
        ...
        <xsl:element name="textarea">
			...
			<xsl:choose>
				...
				<xsl:otherwise>
	                <xsl:attribute name="class">
	                    <xsl:value-of select="'usrFrmTextArea'" />
	                </xsl:attribute>
				</xsl:otherwise>
			</xsl:choose>
        </xsl:element>
    ...
    <xsl:template name="selectBox">
        ...
        <xsl:element name="select">
			...
			<xsl:choose>
				...
				<xsl:otherwise>
	                <xsl:attribute name="class">
	                    <xsl:value-of select="'usrFrmSelect'" />
	                </xsl:attribute>
				</xsl:otherwise>
			</xsl:choose>
        </xsl:element>
